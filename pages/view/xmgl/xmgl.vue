	...
	<view>
			  ...
			  <view class="joiList" v-for="item of datalist"  :key="item.id"  @click="goto(item.id)">
			          ...
			          <view class='weWzpad'>
                                                 ...
                                                 <p class='font14'>项目名称：{{item.title}}</p>
                                                 <p class='font14'>项目类型：{{item.type}}</p>
                                                 <p class='font14'>创建人：{{item.creator}}</p>
                                                  <p class='font14'>创建时间：{{item.created}}</p>
                                                   <p class='font14'>备注：{{item.beizhu}}</p>
...
import uniLoadMore from "@/components/uni-load-more/uni-load-more.vue"
	export default {
        ...
        onLoad() {
                getHandle("workflow/rest/v0/mobile/get.wf?page=1&limit=13&module=4&menu=1").then(res=>{
                    console.log(res)
